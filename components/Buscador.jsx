                        ...
                        {isMobile ? (
                            <AutocompleteMobile
                                ...
                                handleSelectSuggestion={(s) => {
                                    console.log("Seleccionando sugerencia:", s);
                                    setInputValue(s.description);
                                    setShowAutocomplete(false); // Cerrar Autocomplete al seleccionar
                                }}
                                handleApplySuggestion={(s) => {
                                    console.log("Aplicando sugerencia:", s);
                                    setInputValue(s.description);
                                    // No cerrar Autocomplete al aplicar
                                }}
