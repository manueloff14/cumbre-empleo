        ...
        <div className="p-4 border-[1px] border-gray-500 rounded-3xl mt-3 lg:mt-0">
            ...
            <div>
                ...
                <div className="text-sm space-y-2 my-3">
                    <div>
                        <span>Título: <span className="text-gray-300">{data.title_job}</span></span>
                    </div>
                    <div>
                ...
                <a href={data.job_url} target="_blank" rel="noopener noreferrer">
                    <button className="flex gap-3 items-center justify-center p-3 rounded-full hover:bg-gray-900 w-full text-sm border-[1px] border-gray-600">
                        Aplicar ahora
